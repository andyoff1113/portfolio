...
rank_long <- rank_wide |>
  pivot_longer(cols = -county, names_to = "cancer", values_to = "rank") |>
  ...
  mutate(
    ...
    label_color = if_else(percentile >= 65 | percentile <= 20, "white", "black")
  )
```
...
ggplot(rank_long, aes(x = cancer, y = county, fill = percentile)) +
  geom_tile(color = "white", linewidth = 0.6) +
  geom_text(
    aes(label = rank, color = label_color),
