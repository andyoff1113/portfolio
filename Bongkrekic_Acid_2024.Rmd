...
This outbreak was also analyzed with a separate set of methods (Generalized
Gamma delay distributions, binomial attack-rate and case-fatality-ratio
models) and presented as a poster at the **35th Annual Meeting of the
...
outbreaks: Bongkrekic acid poisoning in Taiwan, 2024.* Click the poster
to view the full-resolution [PDF](bongkrek_poster.pdf).
